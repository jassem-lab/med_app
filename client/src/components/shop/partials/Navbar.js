			...
			<nav className="fixed top-0 w-full z-10 shadow-lg lg:shadow-none bg-white">
		        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
		          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
		            <span className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer" onClick={e=> history.push('/')}>Shop</span>
		            <span className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer" onClick={e=> history.push('/blog')}>Blog</span>
		            <span className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer" onClick={e=> history.push('/contact-us')}>Contact us</span>
		          </div>
				              ...
				              <div className="userDropdown absolute right-0 mt-1 bg-gray-200 rounded">
				              	{
			            			...
			            			? <Fragment>
			            				<li className="flex flex-col text-gray-700 w-48 shadow-lg">
						              		<span onClick={e=> history.push('/user/orders')} className="flex space-x-2 py-2 px-8 hover:bg-gray-400 cursor-pointer">
		        ...
		        <div className={ data.navberHamburger && data.navberHamburger ? "px-1 pb-2 md:pb-0 md:px-10 lg:hidden" : "hidden px-1 pb-2 md:pb-0 md:px-10 lg:hidden"}>
		          <div className="col-span-1 flex flex-col text-gray-600">
		            <span className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer" onClick={e=> history.push('/')}>Shop</span>
		            <span className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer" onClick={e=> history.push('/blog')}>Blog</span>
		            <span className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer" onClick={e=> history.push('/contact-us')}>Contact us</span>
		          </div>
		        </div>
	      	</nav>
	        {/* End Navber Section */}
